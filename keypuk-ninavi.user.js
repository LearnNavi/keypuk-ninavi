...
es["Today"] = "Fìtrr";
es["Yesterday"] = "Trram";
es["What are you planning?"] = "Pehemit ngal herawl?";
es["Where?"] = "Peseng?";
...
es["Where are you?"] = "Tsengitpe ngal tok?";
...
es["SORT"] = "WÌNTXU";
es["Top stories"] = "Txina ayvur";
es["Most Recent"] = "Vur asok frato";
es["Account Settings"] = "Fìpoä Sìfkeytok";
es["Privacy Settings"] = "Le'aw 'awpoä Sìfkeytok";
es["Log out"] = "Hum";
es["Help"] = "Srung";
es["Facebook"] = "Keypuk";
es["Use webcam"] = "Sar rel arusikx stä'nìyuti";
es["English (US)"] = "Na'vi";
es["English (UK)"] = "Na'vi";
...
es["More"] = "Nì'ul";
es["About"] = "Teri";
es["Advertising"] = "Tìlusawk";
es["Careers"] = "Tintìn";
es["Create a Page"] = "Ngop Rìkti";
es["Developers"] = "Ayngopyu";
es["Add to my page's favourites"] = "Sung fì'uti ayuru a sunu rìkur oeyä frato";
es["Get updates via RSS"] = "Tel fmawnit ìlä RSS";
es["Report Page"] = "Kulat rìkit";
es["like this"] = "fì'u sunu";
es["talking about this"] = "fì'uteri perlltxe";
es["Wall"] = "'Awkx";
es["Info"] = "Säomum";
es["Friend activity"] = "Tìn eylanä";
es["Photos"] = "Ayrel";
es["See all"] = "Tse'a nìwotx";
es["Recommended Pages"] = "Mawnawka ayrìk";
...
es["See all messages"] = "Tse'a fra'upxaret";
...
es["Mission"] = "Tìkan";
es["Email"] = "Ikran lì'u";
es["Add Friends to chat..."] = "Sung eylanit tìpängkxoru";
es["See Full Conversation"] = "Tse'a tìpängkxoti nìwotx";
es["Clear window"] = "Law si nìwotx";
es["Report as spam"] = "Kulat na tìkawng";
es["Unfollow post"] = "Ftang nirvong kìngit";
es["No new requests"] = "Kea mipa ayätxäle.";
es["You like this"] = "Fì'u sunu ngaru.";
...
// es["Favourites"] = "Ayu a sunu oeru frato";
// es["MORE"] = "NÌ'UL"; */

// Section: Groups
es["Open Group"] = "Sngä'i Pongut";
es["Chat with group"] = "Pängkxo Ponguhu";
es["Edit Group"] = "Latem Pongut";
es["Write post"] = "Pamrel si";
es["Group Info"] = "Hum pongut";
...
es["Search by friends of"] = "Fwew fa eylan";
...
// es["City"] = "";
es["Show comments"] = "Wìntxu aysäplltxevit";
// es["Local business"] = "";
// es["Historical place"] = "";
// es["University"] = "";
// es["Get Directions"] = "";
...
es["Men"] = "Sutan";
es["Women"] = "Suté";
es["Men and women"] = "Sutan sì suté";
// es["Networks"] = "";
// es["Contact info"] = "";
// es["Anniversary"] = "";
// es["Religion"] = "";
es["Description"] = "Tìlusawk";
// es["Political Views"] = "";
...
// es["Living"] = "";
es["Birthday"] = "Sngä'itrr";
// es["Interested in"] = "";
// es["Relatinship Status"] = "";
es["Languages"] = "Aylì'fya";
...
es["Son-in-law"] = "";
es["Daughter-in-law"] = ""; */
es["Partner (male)"] = "Muntxatu (tutan)";
es["Partner (female)"] = "Muntxatu (tuté)";
...
es["Report"] = "Kulat";
// es["Link"] = "Tsaheylu"; // Makes replying impossible. 
